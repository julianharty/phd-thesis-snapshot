...
\tufteskipamount=0.5\baselineskip plus 0.5ex minus 0.2ex % Originally \tufteskipamount=1.0\baselineskip plus 0.5ex minus 0.2ex
...
\usepackage[debug]{mparhack}  % Optionally add [debug] to see details of the fixups in the compilation log.
