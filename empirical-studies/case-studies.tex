...
\begin{enumerate}
    ...
    \item The second perspective is direct engagement with the project teams to facilitate more in-depth research. Two of the projects are opensourced, the rest are proprietary, commercial mission-critical apps. Each of these projects had their own needs in terms of their use of mobile analytics.  % Can we interfere / affect their behaviours
...
\subsection{Six perspectives, in a 3x2 matrix}
The six perspectives are illustrated in Figure~\ref{fig:six-perspectives}~\footnote{Source figure:~\href{https://docs.google.com/drawings/d/1SafKu3uqgl-s8-I8iWSSWmFY4NdlNpw8v6ZiJDGh50c/edit?usp=sharing}{Google Docs: Six Perspectives drawing}.} and listed below:
{\footnotesize
\begin{enumerate}
    \itemsep0em
    \item [1] What do app developers say they do? (understand the status quo).
    \item [2] What's possible, how much can we influence in terms of their processes, their practices?
    \item [3] What does their code tell us? (understand current behaviours in terms of the code that's implemented)~\footnote{NB: it might be useful to reanalyse the projects we studies to identify which ones actively include crash reporting.}.
    \item [4] What's possible in terms of improving the product through the use of mobile analytics?
    \item [5] What do we learn about various analytics tools?
    \item [6] How did we influence the analytics tool developers? based on what was learned in the various case studies?
\end{enumerate}
}

Now there's a clearer grouping for each of the three rows: on processes, on apps, and on the tools. Each study contributes to at least one of these six perspectives. In practice they all contribute to several and may contribute to most of them. \textbf{Challenge: how to structure the studies in the thesis} As each study contributes to a range of the perspectives, I find it hard to decide on a way to report on the various studies clearly so the reader can maintain focus and clarity in terms of the readability of the research.
...
\begin{figure}
    \centering
    \includegraphics[width=15cm]{images/my/six-perspectives-2x3-matrix.png}
    \caption{Six Perspectives}
    \label{fig:six-perspectives}
\end{figure}
...
This chapter first introduces the range of known data sources used in at least one of the case studies, in \secref{section-case-studies-data-sources}. 

Section \secref{section-field-reports-case-studies} presents the app developers' perspectives. 

The direct engagement case studies start with the two opensource case studies \secref{section-kiwix-case-study} and \secref{section-catrobat-case-study}. These are followed with extracts from one or more commercial projects in \secref{section-corporate-engineering-case-studies}. 
