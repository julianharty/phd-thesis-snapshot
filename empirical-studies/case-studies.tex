...
\newthought{The rest of this chapter}

This chapter first introduces the range of known data sources used in at least one of the case studies, in \secref{app:data-sources}. 
