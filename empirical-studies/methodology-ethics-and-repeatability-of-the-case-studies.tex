...
Figures \ref{fig:outputs_from_inputs_code_config} and \ref{fig:analytics-feedback-cycle} are connected and illustrate firstly what may affect the outputs pertaining to mobile analytics in isolation, and then how that fits into a larger, holistic feedback cycle. TODO these figures will be redrawn and explained.


\begin{figure}
    \centering
    \includegraphics[width=13cm]{images/rough-sketches/outputs_from_inputs_code_config.jpeg}
...
\begin{figure}
    \centering
    \includegraphics[width=13cm]{images/rough-sketches/analytics-feedback-cycle.jpeg}
    \caption{Analytics Feedback cycle (draft)}
    \label{fig:analytics-feedback-cycle}
\end{figure}


%%%%% Some ad-hoc notes during the call with Arosha
% Some features are contextual...
% Clarify that the analytics were checked many times, pertinent examples were saved. 
% Consider redacting personal communications with the stakeholders if I want to provide emails as supporting evidence for quotes and/or claims I make in the thesis.. 
