...
\newthought{General ethical considerations in \href{glossary-esse}{ESSE}}

TODO expand on the foundations established in~\citep{singer2002_ethical_issues_in_empirical_studies_of_software_engineering}

Informed consent

\newthought{How ethical studies applied to my case studies and why}


\newthought{Steps taken to mitigate the relevant ethical issues in the case studies}

Participants are anonymous with a couple of exceptions: 1) the information is already public, 2) they were happy to be identified in public as contributors to this research.


\newthought{The need for beneficial relationships}
