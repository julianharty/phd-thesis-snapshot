...
\newcommand{\head}[2]{\multicolumn{1}{>{\centering\arraybackslash}p{#1}}{\textbf{#2}}}  % From https://latex.org/forum/viewtopic.php?t=20931
...
\begin{table}
    ...
    \begin{tabular}{lrrlllllllll}
        \head{1.9cm}{Case Study} &\head{0.9cm}{Apps} &\head{1.1cm}{Active Installs} &\head{1.6cm}{Role of Researcher} &\head{2.0cm}{Main Research Focus} &\head{2.0cm}{Development Practices} &\head{1.5cm}{Mobile Analytics} &\head{3.5cm}{Case Study Objectives} &\head{1.4cm}{Privacy} &\head{2.5cm}{Opportunities} &\head{3.2cm}{Findings} \\
        \toprule
        \rowcolor{Gray}
