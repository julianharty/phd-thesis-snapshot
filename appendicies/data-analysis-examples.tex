...
\textbf{Findings, and how they were validated}
This and other similar dashboard reports for Kiwix and Catrobat, in particular, were analysed using the sense-making methods described in \ref{methodology-sense-making-method}\index{Sense-making}. Beacon-finding, described in \ref{section-beacon-finding-method}\index{Beacon-finding} identified dates and points on the various graphs. 
