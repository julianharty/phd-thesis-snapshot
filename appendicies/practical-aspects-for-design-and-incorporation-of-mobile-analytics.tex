...
Testing of the analytics and testing of the incorporation of analytics into an app are both relevant. In terms of testing the incorporation, there is a request to add a fake implementation of one of the mature and popular mobile analytics libraries~\cite{segmentio_analytics_android_issue_770_fake_implementation_for_testing}. One of the core developers acknowledges such a feature does not exist and it may be useful. 
