...
\chapter{Placeholder for Introduction} %\input{mainchapters/kaobook-introduction.tex}
\chapter{Placeholder for A Grounding in the domain} %\input{mainchapters/kaobook-a-grounding-in-the-domain.tex}
\input{mainchapters/kaobook-related-work}

\chapter{Placeholder for the methodology}%\input{mainchapters/kaobook-methodology}
\chapter{Placeholder for the Case Studies Overview} %\input{mainchapters/kaobook-case-studies-overview}
