...
\begin{enumerate}
    \item 	Giovanna Avellis, Julian Harty, Yijun Yu. \emph{``Towards mobile twin peaks for app development''}. In MOBILESoft '17 Proceedings of the \nth{4} International Conference on Mobile Software Engineering and Systems. 2017. \href{https://doi.org/10.1109/MOBILESoft.2017.10}{DOI 10.1109/MOBILESoft.2017.10}~\cite{avellis_harty_yu_towards_mobile_twin_peaks}
    ...
    \item Isabel Evans, Chris Porter, Mark Micallef, Julian Harty. \emph{``Stuck In Limbo With Magical Solutions: The Testers’ Lived Experiences of Tools and Automation''}~\cite{evans2020stuck}. 
    
    \textbf{My contribution:} I helped inspire the research and contributed to revising and improving the paper.
    
    \item Julian Harty. ICST 2020 - Doctoral Symposium \emph{``How Can Software Testing be Improved by Analytics to Deliver Better Apps?''}~\cite{harty2020_how_can_software_testing_be_improved_by_analytics_to_deliver_better_apps}.
    
    \item Julian Harty. TAIC-PART 2020 \emph{``Fast Abstract: Data Dynamics for Testing Systems''}~\cite{harty2020_fast_abstract_data_dynamics_for_testing_systems}.
    
    \item Isabel Evans, Chris Porter, Mark Micallef, Julian Harty. TAIC-PART 2020.~\emph{``Test Tools: an illusion of usability?''}~\cite{evans2020_test_tools_an_illusion_of_usability}.
    ...
    \item Julian Harty. ICGSE 2020.~\emph{``Designing Engineering Onboarding for 60+ Nationalities''}~\cite{harty2020_designing_engineering_onboarding}. (Nominated for best paper.)
    
    \item Julian Harty with 5 co-authors. MOBILESoft 2021.~\emph{``Logging Practices with Mobile Analytics: An Empirical Study on Firebase''}~\cite{harty2021_logging_practices_with_mobile_analytics}. This paper intersects with the case study:~\href{section-research-in-logging-practices}{\nameref{section-research-in-logging-practices}}. 
...
\subsection{Software}
Please see the ~\hyperlink{app:software-contributions}{\emph{\nameref{app:software-contributions}}} chapter in the appendices for details. 
\clearpage
