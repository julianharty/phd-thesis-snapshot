...
\section{Crashes are not the only, or best, oracle}
If detecting crashes is a sufficient oracle for researchers, why do assertions exist? and why are they used by developers in their automated tests?  (see my handwritten note on p.16 of \cite{zein2016_a_systematic_mapping_study_of_mobile_application_techniques}
...
I'm currently inspired by \href{https://about.sourcegraph.com/blog/developer-productivity-thoughts}{A dev's thoughts on developer productivity}~\cite{liu2022_a_devs_thoughts_onDeveloper_productivity}. The following material was extracted from the Apps and their Artefacts chapter; on reflection it probably belongs better in the Analytics in Use chapter or in something like the main Discussion chapter or Future Work...
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/rough-sketches/developer-inner-loop-outer-loop.jpeg}
    \caption{Developer Inner Loop, Outer Loop\\ redrawn from \cite{liu2022_a_devs_thoughts_onDeveloper_productivity}}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/rough-sketches/dev-app-reliability-iterative-loop.jpeg}
