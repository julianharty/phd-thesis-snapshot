...
Software analytics was a recently established field of research - Microsoft used usage data to measure and improve Windows Software~\sidecite{musson2013_leveraging_the_crowd_how_48000_users_helped_improve_lync_performance}. A longitudinal study using custom opensource mobile analytics, called Insight, demonstrated ways in-app mobile analytics was able to help developers of two popular apps to improve the performance of their mobile apps~\sidecite{patro2013_capturing_mobile_experience_in_the_wild}.
