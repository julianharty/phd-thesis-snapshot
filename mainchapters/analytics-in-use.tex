...
% And see https://en.wikipedia.org/wiki/Shift-left_testing (weak so not cited)
...
Similarly, the Kiwix project chose to migrate code from Java to Kotlin, in part to prevent some errors (including errors that led to crashes) from occurring. 
