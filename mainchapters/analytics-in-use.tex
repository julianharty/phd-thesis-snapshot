...
\julian{TODO introduce the rest of this chapter. Here's my current running order: \href{aiu-motivating-factors-section}{motivation}, \href{aiu-choosing-mobile-analytics-section}{choosing mobile analytics}, \href{aiu-application-of-mobile-analytics-section}{application}, 
...
\href{aiu-interventions-section}{Interventions to increase use of mobile analytics}, 
the~\href{aiu-discussion-section}{discussion}}

\textbf{Themes that emerged}\pending{This probably wants relocating, possibly into the Methodology chapter?}: 
%
In the analysis of the findings there were 41 L1 themes identified in the spreadsheet. These were grouped into  4 L2 themes, they were also ranked to help select good examples for this chapter. Figure \ref{fig:analytics-in-use-fishbone-diagram} shows the mapping and key relationships between the themes.\pending{Note: this is a work in progress figure with notes for me that aren't readable here. This figure will be replaced as I edit this chapter.}
...
The four level 2 themes are each covered in this chapter, they are: 1) motivation, 2) benefits \& achievements, 3) competence \& optimisations, and 4) SNAFU.\pending{Currently there's a fifth L2 theme: evidence which will probably disappear as I revise the chapter.}

Motivation investigates what drives the developers to use mobile analytics to improve their apps, for instance is it `fire-fighting' or `optimisation'? \secref{aiu-motivating-factors-section} presents evidence for this overall theme.
...
And finally in terms of the higher-level themes, the context the developers are working in plays a major factor in what happens in terms of their use of mobile analytics so it's key to consider the evidence for this theme in \secref{aiu-snafu-and-real-world-conditions-section}.
...
\subsection{Bug reproduction}~\label{aiu-bug-reproduction}
...
\newthought{Improve engineering practices}
...
Kiwix download code substitution, positive effects, knock-on effects in terms of functionality.\pending{Expand this terse wording.}
...
% Note Robospice is still in 500+ apps which may be experiencing an ever increasing crash rate as newer versions of Android become more prevalent. https://www.appbrain.com/stats/libraries/details/robospice/robospice
...
\newthought{Third-party software challenges}
...
\newthought{Crash reproducibility:} Reproducing and repairing crashes in Android apps has received significant attention from academic researchers. In~\citet{tan2018_repairing_crashes_in_android_apps} they were able to automatically fix some of the crashes that were able to be repeatably triggered by existing GUI-driven automated tests. In at least one case the automated fix was more correct than the flawed one the original developer had implemented. 
