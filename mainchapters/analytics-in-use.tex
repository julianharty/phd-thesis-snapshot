...
%
In the analysis of the findings there were 41 L1 themes identified in the spreadsheet. These were grouped into  9 L2 themes. Both the L1 and L2 themes were ranked. Figure \ref{fig:analytics-in-use-fishbone-diagram} shows the (incomplete) mapping.

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{images/rough-sketches/analytics-in-use-fishbone-diagram-14-jun-2022a.jpeg}
    \caption{Analytics-in-Use fishbone diagram (incomplete)}
