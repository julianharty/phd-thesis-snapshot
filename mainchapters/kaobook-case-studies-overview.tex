...
\index{Analysis!Sourcecode}Sections \ref{case-study-overview-gtaf} to \ref{case-study-overview-moonpig} presents four app-centric case studies where the developers were asked of their experiences of using mobile analytics. None of these provided access to the source code of their apps. In contrast \ref{case-study-overview-smartnavi}) to \ref{case-study-overview-C1}) did provide access to their sourcecode. As only three  of these case studies have opensourced their source code, and only \myindex{SmartNavi} currently uses an in-app mobile analytics SDK the app-centric case studies weer complemented that research by investigating the source code of 107\sidenote{SmartNavi is included in these 107 projects.} opensource projects for active Android apps where the source code was freely available on GitHub. 
