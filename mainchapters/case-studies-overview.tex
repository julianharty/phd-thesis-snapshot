...
\begin{itemize}
    ...
    \item App-centric case study procedure - specifics for this case study
...
\begin{table}[htbp!]
    ...
    \begin{tabular}{ll}
       ...
       Google Play Home & \url{https://play.google.com/store/apps/} \\
       Founded &\emph{date}\\
...
Further examples and details of the use of mobile analytics are in the next three chapters.
...
\begin{table}
    ...
    \begin{tabular}{p{2.6cm}p{2.6cm}rp{3.5cm}p{3.5cm}}
        ...
        \toprule
         1-to-1 meetings with founders & contemporaneous notes\footnotemark & 3 & Set scope and direction & 1 was in-person, 2 were online \\
         email conversations & GMail & 10\textsuperscript{1} & Insight into the Expo bug & Initiated by the researcher. \\
         Google Play Console with Android Vitals &Interactive screenshots \& Vitals-scraper outputs &10\textsuperscript{1} & Insight into the reporting effects of the Expo bug and the reporting provided for React-Native apps &  \\
         Sentry & Interactive screenshots & 10\textsuperscript{1} & Insights into Sentry's reporting & Access continued until Sentry removed multi-account access from their free tier. \\
         Sentry automated emails &GMail & 10\textsuperscript{2} & Insights into Sentry's reporting, dev practices, \& cross-platform reporting & \textit{ditto.} NB: they continue to send weekly reports by email. \\
         \bottomrule
    \end{tabular}
...
The main source of data are emails from Ian, the CTO. These were supplemented with some additional research online using grey literature and grey data.
...
The startup was subsequently able to raise a round of funding and grow to six people. The project later returned to be a side-project which is maintained and updated~\citep{alexander2021_linkedin_profile}. The app has a strong positive User Experience rating of 4.18/5.00~\footnote{\url{https://onemindpsyberguide.org/apps/moodspace/}}.
...
\section{App-centric: Moonpig} % The title is used throughout this file, do a search and replace.
...
\section{App-centric: Smartnavi}\improvement{This is an additional contribution that was easy to add now there's a consistent structure to introduce the case studies.} 
...
\section{App-centric: Kiwix} % The title is used throughout this file, do a search and replace.
...
\section{App-centric: C1} % The title is used throughout this file, do a search and replace.
% A couple of sentences to introduce them
...
\begin{table}[htbp!]
    ...
    \begin{tabular}{lp{9cm}}
       ...
       Active period & Oct 2020 - April 2021 \\
       \bottomrule
    \end{tabular}
