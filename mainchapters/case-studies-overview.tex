...
\begin{table}
    ...
    \footnotesize
    \tabcolsep=0.12cm
    \begin{tabular}{p{2.3cm}p{2.1cm}r>{\raggedright}p{2.4cm}>{\raggedright}p{2.8cm}>{\raggedright\arraybackslash}p{3.2cm}}
        Data Source & Records & Volumes & Analysis method & Contribution & Remarks \\
        \toprule
...
\begin{table}
    ...
    \footnotesize
    \tabcolsep=0.12cm
    \begin{tabular}{p{2.2cm}p{2.3cm}r>{\raggedright}p{2.1cm}>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4cm}}
        Data Source & Records & Volumes & Analysis method & Contribution & Remarks \\
        \toprule
...
\begin{table}
    ...
    \footnotesize
    \tabcolsep=0.12cm
    \begin{tabular}{p{4cm}p{2.4cm}r>{\raggedright}p{2.1cm}>{\raggedright\arraybackslash}p{3cm}>{\raggedright\arraybackslash}p{1.2cm}}
        Data Source & Records & Volumes & Analysis method & Contribution & Remarks \\
        \toprule
...
\begin{table}
    ...
    \footnotesize
    \tabcolsep=0.12cm
    \begin{tabular}{p{4cm}p{2.4cm}r>{\raggedright}p{2.1cm}>{\raggedright}p{2.2cm}>{\raggedright\arraybackslash}p{2.5cm}}
        Data Source & Records & Volumes & Analysis method & Contribution & Remarks \\
        \toprule
