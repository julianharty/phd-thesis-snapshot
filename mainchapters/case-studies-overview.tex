...
\begin{enumerate}
    \item Creating small experiments in the form of Android apps that exercised at least one mobile analytics service.
    \item Contributing to opensource mobile analytics projects.
    \item Research into logging performed by Android app developers and the development of software utilities to further that research.
\end{enumerate}


\subsection{Dynamic tests to increase coverage of mobile analytics services}
...
\subsection{Contributions to opensource mobile analytics projects}
...
\subsection{Android log-centric experiments}
...
\textbf{TODO integrate the relevant content from \texttt{empirical-studies/logging-case-studies}}
...
Introduce the next three chapters and their connections to the six perspectives and to each other (they may cross-reference e.g. in their respective discussion section).
% Excluded from this chapter are: the NlNet Android app for EduVPN and the discussion with Sunil on a bank in Australia.