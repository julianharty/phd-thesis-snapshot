...
% \yy{Figure \ref{fig:visual-connections-in-research}}{Nice diagram! Would be good to make the layers explicit, and show the semantics of the flow clearly: are the arrows to Google a dataflow, or sth. at metalevel, i.e. for validation only?} aims to provide a visual overlay of the main practical elements of the research. \yy{The practical research}{Need to complete the sentences, what is liminal? Change Kiwix/Catrobat apps to "Kiwix/Catrobat teams"? }
...
I made data \yy{available}{Can you place a URL to the data you shared to the research community?} for further research based on data originally only made available to app developers.

The research has been presented at various conferences and workshops, including at NII Shonan \yy{:}{2019 meetings on} "Release Engineering for Mobile Applications". 

\section{Outline of this thesis}
Bugs are ubiquitous in software (c.f. even \yy{Knuth's challenge}{Can you spell out the challenge or add a citation?} was met) and self-aware developers expect there will be bugs in their software. 

Even top development teams are likely to learn of bugs they were not able to find, and cannot reproduce. For instance, Google's Android Auto Team have asked for help from end users to identify patterns that may help the team find and address \yy{the}{a} bug~\footnote{\url{https://support.google.com/androidauto/thread/2865341?msgid=44437416}}. As reported by \texttt{autoevolution} in May 2020:  
