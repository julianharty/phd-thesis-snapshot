...
\begin{figure}[htbp!]
    ...
    \caption{The Research focuses on automated checks and tests performed by the app store, automated analytics and reports both in-app and at the platform level. \\ \\Other sources of feedback available to developers includes feedback from people and feedback from their development tools and CI automation.}
\end{figure}
...
\textbf{MUST-DO} introduce these concepts here and link to the section in the ground chapter which has more detail.
