...
The first is a mapping study that aimed to identify the requirements for in-app feedback tools. After various filtering they selected 36 papers. They analysed and categorised the types/forms of feedback, \emph{e.g.} text, audio, video, [file] attachments, and even emotions and behaviour. They also determined whether feedback was initiated by the user or by the app. They did not provide much more information, not even the details of the 36 papers, and they indicated this is a preliminary, interim publication~\sidecite{TERTOVMASYAN2021_requirements_for_in_app_feedback_tools}. 

In a subsequent with three shared authors they discuss their findings of providing in-app feedback to improve the quality of apps~\sidecite{scherr2022_the_way_it_made_me_feel_creating_and_evaluating_in_app_feedback_etc}. They created and testing their implementation of in-app feedback using an app designed for Citizens to provide feedback to a smart city project. Their test was performed with friends and colleagues of the team so not likely to be representative in terms of the content or behaviours. Nonetheless their research and their prototype in-app feedback may be of interest to app developers in future, especially given their analysis of how to design the feedback. 

Neither of these papers mention software analytics, nonetheless their app might include in-app-software analytics.
