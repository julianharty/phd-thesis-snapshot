...
The modern mobile ecosystem, illustrated in Figure~\ref{fig:my_modern-mobile-app-ecosystem}, and inspired by \sidecite[][Figure 1, on p. 96]{KAPOOR2021_socio_technical_platform_ecosystems_etc}, 
...
The research reported in this thesis sits at the intersection of prior art in several related fields, namely: software quality, software analytics, and the mobile device ecosystem. %As researchers we understand and recognise there are gaps in the current state of the art. 
...
\begin{figure}
    \centering
    \includegraphics[width=14cm]{images/related-work/Buse_and_Zimmermann_2010_figure.pdf}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\textwidth]{images/xkcd/star_ratings.pdf}
