...
\newthought{A diagram to map out the connections between the case studies and the evidence they provide. Show the dependencies between the RQs and the case studies and the evidence they provide.}

Evidence at the base. c.f. Akshika's diagrams. 

The logging case study - inductive analysis to determine the patterns. 

\newthought{Plain thoughts on the methodology used}
