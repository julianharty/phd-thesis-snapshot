...
The app-centric case studies have several phases, this section explains each of the main phases.
...
\begin{itemize}
    ...
    \item As an observer, the researcher observes the available development artefacts and mobile analytics. If practical and permitted they also observe the development practices. 
