...
\buzzwords{Theoretical Framework, Conceptual Framework, make assumptions explicit, methodological analysis using prior publications to identify a vocabulary - SE in practice, qualitative analysis,  ...}
...
\begin{description}
    \itemsep0em
    \item[Research Method] Case Study
    \item[Research Tool] Action Research
    \item[Research Tool] [Semi-] Controlled Experiment
    \item[Research Tool] Hackathon
    \item[Analytics Provider] Google Play Console with Android Vitals
    \captionof{methodology-map}{Kiwix case study methodology map}
    \label{methodology-map-kiwix-case-study}    
\end{description}
}
% Thanks to https://fedoramagazine.org/latex-typesetting-part-1/ for helping me discover {description}

{\footnotesize
\begin{description}
    \itemsep0em
    \item[Research  Method] Inductive analysis of source code
...
\isabel{The key concepts and the theoretical framework underpin the methodology}
