...
\textit{This chapter is scoped to make it short enough to be readable.} 

\julian{1-para T tactic of the broad literature, I'm picking these ones that are most directly germane to my research. Where others have done similar work they've done so in other ways eg MSR rather than focusing on the development teams. When you observe the teams the effects of the processes, artefacts, and the tools emerged. This is why I've picked these 3 aspects and 6 perspectives. SQ improvement.}
...
Their research is one of several that discusses the gaming of app store ratings, such gaming is unsurprising given the importance placed on these ratings and particularly in having mobile apps with high ratings in the app store. % Ratings are one of the topics of the next section given their importance in the mobile app ecosystem. % Commented out as I need to add some more material below so the following transition won't work.
...
\section{Sources of information for developers of mobile apps}
...
The feedback source is mainly from humans for: ratings, reviews, social media, email to the dev team, manual testing, and code reviews. The feedback sources for the other eight sources are mainly automated. Developers need to be involved in setting up many of the feedback sources and they choose which ones to act on.
...
% or \section{Developing Mobile Apps}
...
\subsection{Mobile Analytics}~\label{rw-mobile-analytics-papers}
