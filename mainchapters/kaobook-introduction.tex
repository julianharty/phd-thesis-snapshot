...
>>>>>>> 945f693bba7f41f0cffff0ad716dda110969d333
\begin{enumerate}
    %\setlength\itemsep{-0.5em} %\itemsep0em
    \item [Chapter 1] has introduced this thesis and covers the research's focus, questions, and strategy. 
    \item [Chapter 2] prepares the ground for the rest of this thesis by explaining contemporary development practices for mobile apps. It then presents five conceptual models related to mobile apps. These are followed by several, relevant, practical details. % explaining various concepts and the practical context of mobile app development that is relevant
    \item [Chapter 3] covers the related work.
    \item [Chapter 4] describes the methodology.
    \item [Chapter 5] provides an overview of the various case studies together with complementary research that augmented aspects of the case studies.
    \item []
    \item [Chapter 6] Findings related to how developers use mobile analytics.
    \item [Chapter 7] Findings concerning the apps and their related artefacts.
    \item [Chapter 8] Findings about the mobile analytics tools and related services.
    \item []
    \item [Chapter 9] A discussion regarding the findings and the research.
    \item [Chapter 10] The conclusions and future work.
\end{enumerate}
\end{comment}
