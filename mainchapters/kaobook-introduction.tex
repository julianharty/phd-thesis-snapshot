...
\begin{enumerate}
    ...
    \item platform-provided analytics\index{Platform-provided analytics}: automated analytics and reports provided by gathered Android Vitals~\sidenote{Android Vitals is integrated into \myindex{Google Play Console} which provides additional functionality including app store metrics, ratings and reviews, release management, and so on.}, which is integrated into the Google Android platform and available free of charge for all developers of apps in the Google Play app store,
