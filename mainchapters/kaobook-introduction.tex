...
\begin{kaobox}
The core argument of the introduction chapter can be summarised as:\sidenote{These are Arosha's comments for this chapter, reformatted so they're visible and introduce the chapter. They can be kept if they help the reader, else they'll be removed before the revised thesis is submitted.}
