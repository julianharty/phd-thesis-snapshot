...
A couple of rough sketches, Figures~\ref{fig:apps-on-device-boundaries} and~\ref{fig:on-device-logging} present two views of apps installed on any given mobile device. 
\end{comment}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/wikipedia/Yin_yang.pdf}
