...
\newthought{Mobile analytics:} comprises software, systems, and sometimes services. Broadly we can read about them, study their source code, analyse, test, and use them directly, and ask others for their perspectives and insights. 
...
\newthought{Forced updates?} Some developers, and some platforms, may incorporate mechanisms to encourage or even try to force users to update their apps~\sidenote{Discussed in chapter 3 of \cite{orosz2021_building_mobile_apps_at_scale} where they give examples of companies who actively use forced updates.}. However, doing so may upset and alienate some users, and as was observed in the commercial case study, \myindex{C1}, there were still users who continued to use old releases with high failure rates. % Commented out until I retrieve my notes on the following: One of the case studies, \Gls{gtaf}\index{GTAF}, has used these mechanisms and this topic will be expanded in that case study. In contrast, the 
