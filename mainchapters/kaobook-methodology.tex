...
\subsection{Sense-making}\index{Sense-making}~\label{methodology-sense-making-method}
...
\subsection{Sense-building}~\label{methodology-sense-building}
...
\subsubsection{Across-case comparisons}~\label{across-case-comparisons-research-method}\index{Across case comparisons method}
