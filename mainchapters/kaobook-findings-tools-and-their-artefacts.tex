...
\begin{table}
    ...
    %\begin{tabular}{L{0.05\texwidth} L{0.35\textwidth} L{0.4\textwidth}}
...
This conversation came about in part from the experiences in 2019 of using Fabric Crashlytics in Catrobat's Pocket Code Android app, and in part from the following mini-experiment. 

\newthought{Travel Europe app mini-experiment: }
...
developed a set of opensource projects called CrashScope which they and various other providers of crash reporting \Glspl{sdk} used to test the behaviours of their respective \Gls{sdk}. The report was last run in summer 2017 however the site remained online for another 3 years before disappearing. 
