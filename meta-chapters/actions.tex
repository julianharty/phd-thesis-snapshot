...
\begin{enumerate}
    ...
    \item Clean up the Author's declaration.
    ...
    \item Fix the 'unknown' citations e.g. for OBB in the glossary.
    ...
    \item Integrate `Clearly the catgorisation ...' with `Note: Figure ...' in the Methodology section (4.3)

    \item Do have a go at sketching the research version of the sense-making process figure (4.3)

    \item Complete the Code Analysis subsection.
