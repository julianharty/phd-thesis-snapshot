...
\begin{enumerate}
    ...
    \item Hour 1 of 2 pairing with Marian.
    \item Hour 2 of 2.
    \item Editing the introduction from top to bottom.
    \item ditto.
    \item ditto. It's coming together.
    \item Miscellaneous stuff, e.g. downloading and reading papers to help support the research aspects of the introduction.
    \addtocounter{enumi}{4}
    \item Spent about 4 to 5 hours getting an offline environment working so I could work on the thesis offline.
    \addtocounter{enumi}{10}
    \item Worked while in Greece on revising the Introduction, in particular, and other aspects of the thesis, mainly based on first Marian's comments, then Arosha's, and finally Isabel's.
    \item Discovered a highly relevant PhD thesis on crashes in Android apps and a related paper. Reading parts of both of these.
    \addtocounter{enumi}{2}
    \item Spent several hours working on reading, evaluating, and writing about~\citep{Kechagia2015_charting_API_minefield_using_telemetry_data}. Also learned how Joe had implemented his ANR generator in an app based on our Android Crash Dummy opensource app to compare his approach with those in Google Android documentation on ANRs.
\end{enumerate}