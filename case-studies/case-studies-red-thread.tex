...
\newthought{Marian's comments taken from the methodology notes earlier in the thesis red thread}

The map is vital.

Need to be more precise in how you report this (I know this is notes, but...), e.g., the case studies use mixed methods (not just the expansion).  You need to convey rigour within the constraints of access to case studies.
...
Maximise my ability to make systematic use of what was pragmatically available: Opportunistic access, then I worked systematically and rigourously.

methodology combines reasoning with the method.

Start with what data did I collect and how I collect it.
I can compare case studies with similar sources of data.
What are the issues that arise?
Providing a clear rationale
Demonstrating the demands of rigour. Explicit reporting of what I had and the efforts I made to handle the data systematically and be vigilant for bias.

Avoid being considered as anecdotal. Amplify with the dialogues I had as part of the teams.

Explain there's a really clear audit trail and justification for my conclusions.

\begin{itemize}
    \item Characterise the case studies.
    \item Make explicit what data I collected and for what purpose. 
    \item Separate insights into a separate table. 
\end{itemize}

conceptual prerequisite tree is unclear, it has:
2 threads of enquiry
Do the boxes have the same 

prerequisites are to effective analytics. The figure is of a framework either corroborates or revises the approach. It could become an actionable list. Each item identifies a potential points of failure. Or it could be used as a retrospective of the factors I observed. 
It could be used to reflect on practice.
Breaks the topics down 

Quality of reporting of the empirical work is key

10:15 on Frid 10th Sept.
