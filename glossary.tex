...
% BDD
\newacronym[type=\glsdefaulttype, description = {Behaviour-Driven Development is intended to close the gap between business people and technical people, \href{https://cucumber.io/docs/bdd/}{cucumber.io/docs/bdd/}}]{bdd}{BDD}{Behaviour-Driven Development}

\newacronym{cb}{CB}{Continuous Build}
...
% FIM
\newacronym{fim}{FIM}{Fault Inducing Module}
...
% MSR
\newacronym[type=\glsdefaulttype, description={Mining Software Repositories is both a conference series and a community of researchers interested in that topic. \href{http://www.msrconf.org/}{www.msrconf.org/}}]{msr}{MSR}{Mining Software Repositories}

% npm
\newacronym[type=\glsdefaulttype, description={npm is used to manage and publish software packages. `Contrary to popular belief, npm is not in fact an acronym for ``Node Package Manager''; It is a recursive bacronymic abbreviation for "npm is not an acronym" (if the project was named "ninaa", then it would be an acronym).' See:  \href{https://github.com/npm/cli\#is-npm-an-acronym-for-node-package-manager}{github.com/npm/cli\#is-npm-an-acronym-for-node-package-manager}}]{npm}{npm}{``npm is not an acronym''}
...
% OOM
\newacronym[type=\glsdefaulttype, description={OutOfMemoryException Error, abbreviated to OOM. Oracle provides a guide oriented at programmers at \href{https://docs.oracle.com/javase/8/docs/technotes/guides/troubleshoot/memleaks002.html}{docs.oracle.com/javase/8/docs/technotes/guides/troubleshoot/memleaks002.html}}]{oom}{OOM}{OutOfMemoryError Exception}

% PHeT
\newacronym[type=\glsdefaulttype, description={PhET is a project that creates and provides interactive simulations on computers for science and mathematics, free of charge. PhET stands for Physics Education Technology~\cite{wieman2008_phet_simulations_that_enhance_learning}. More information on the project is online at \url{https://phet.colorado.edu/}. The Kiwix project created the first mobile app for the project with the project's permission}]{phet}{PhET}{Physics Education Technology. At their request the Kiwix project renamed our custom app from PhET to `Physics and Chemistry simulations'. In this research PhET is commonly used for brevity.}

% PII
\newacronym[type=\glsdefaulttype, description={PII is \emph{``Personally Identifiable Information; Any representation of information that permits the identity of an individual to whom the information applies to be reasonably inferred by either direct or indirect means."}~\cite{nist_pii}}]{pii}{PII}{Personally Identifiable Information}
...
% PLR (Pre-launch report)
\newacronym[type=\glsdefaulttype, description={Pre-launch report (PLR) This term is occasionally used in Google Android materials, for example in~\cite{androiddevelopers2019_improve_your_app_and_game_quality_with_android_vitals_googleio2019}}]{plr}{PLR}{Pre-Launch Report}
...
% SAMOA
\newacronym{samoa}{SAMOA}{Software Analytics for MObile Applications, source \href{https://samoa.inf.usi.ch/about/}{samoa.inf.usi.ch/about/}}
...
% SNAFU
\newacronym[type=\glsdefaulttype, description={SNAFU describes a common, normal condition where things are generally messed up. The source comes from the military \url{https://english.stackexchange.com/a/310644/433415} where I learned it.}]{snafu}{SNAFU}{Situation Normal All F**ked (Fouled) Up}
...
\newglossaryentry{glossary-analytics-system}{
    name = {Analytics system},
    description = {Analytics systems subsume the tool and provide a service. They generally include persistent storage of the collected data, they may also persist analysis and/or reports. Persistency may be for a finite period, and that may vary depending on pricing, data volumes, and so on.}
}
...
\newglossaryentry{glossary-app}{
    name = {App},
    description = {A common abbreviation for a software application installed on mobile smartphone-based devices}
}

% Application binary
\newglossaryentry{glossary-app-binary}{
    name = {Application binary},
    description = {The file(s) that contain the compiled source code and associated libraries and resources needed to run the app on a device}
}

% Bad behavior threshold
\newglossaryentry{glossary-bad-behavior-threshold}{
    name = {Bad Behavior Threshold},
    description = {Google Play defines two bad behaviour thresholds that are used within the Google Play system to measure the crash rate and the \Gls{anr} rate. The threshold for crashes is 1.09\% and 0.47\% for Glspl{anr} rate}
}
...
% Catrobat
\newglossaryentry{glossary-catrobat}{
    name = {Catrobat},
    description = {Catrobat is a visual programming language and set of creativity tools for smartphones, tablets, and mobile browsers. Catrobat and the software developed by the Catrobat team are inspired by the programming system developed by the Lifelong Kindergarten Group at the MIT Media Lab. Catrobat --- \href{https://catrobat.org/}{catrobat.org/} and \href{https://developer.catrobat.org/}{developer.catrobat.org/} --- is an independent non-profit project creating free open source software (FOSS) under AGPL and CC-BY-SA licenses. (Extracts from \href{https://play.google.com/store/apps/details?id=org.catrobat.catroid}{play.google.com/store/apps/details?id=org.catrobat.catroid}}
}

% Chrome.apk
\newglossaryentry{glossary-chrome-apk}{
    name = {Chrome.apk},
    description = {Google's Chrome browser appears on Google Android devices as a binary file called Chrome.apk, developers can choose to integrate it into their Android app to provide web browser capabilities and many developers have chosen to do so}
}
...
\newglossaryentry{glossary-crash-cluster}{
    name = {Crash cluster},
    description = {A grouping of crashes deemed to be effectively the same crash that occurred at least once. Often statistics and other information is provided in the crash cluster}
}
...
% F-Droid
\newglossaryentry{glossary-f-droid}{
    name = {F-Droid},
    description = {
        A significant, yet minor, app store that hosts Android apps. All the apps are opensource projects. The apps must not contain any proprietary, closed-source code. In practice this means they do not contain any in-app mobile analytics. \href{https://f-droid.org/}{f-droid.org/}
    }
}
...
% GitHub
\newglossaryentry{glossary-github}{
    name = {GitHub},
    description = {The world's most popular home for source code repositories. It provides private and public repositories. Much research into Android source code uses public repositories on \href{https://github.com/about}{About GitHub}}
}

% GitLab
\newglossaryentry{glossary-gitlab}{
    name = {GitLab},
    description = {A popular home for source code repositories. It provides private and public repositories, see \href{https://about.gitlab.com/}{About GitLab} for more details}
}
...
% Heatmap / Heatmapping
\newglossaryentry{glossary-heatmap}{
    name = {Heatmap},
    description = {In the context of this research, a heatmap is a visual representation of the screen of a touchscreen device where what was displayed on the screen has been overlaid with translucent colours that indicate areas one or more people have touched on that screen. Generally red is used to indicate the most touched areas and other colours for less touched areas. There may be a range of colours used, these are generally chosen by the provider of the heatmap tool or service}
}

% iff
\newglossaryentry{glossary-iff}{
    name = {iff},
...
\newglossaryentry{glossary-in-app-analytics}{
    name = {In-app analytics},
    description = {Usage-based analytics recorded by incorporating software into a mobile app. The analytics may be in the form of source code files, a library, or an SDK. Often they are provided by commercial specialist service providers. Some commercial providers provide their library or SDK as opensource code, packaged as a library or SDK, others provide a binary file.}
}
...
\newglossaryentry{glossary-platform-analytics}{
    name = {Platform analytics},
    description = {
        Usage-related analytics for various app-related information. The analytics are obtained by a mobile app platform, such as Google, on end-user devices (including smartphone and tablet devices), transmitted over an internet connection, and then processed by the platform provider to generate the analytics. Aspects of these analytics may be shared with various parties.
    }
}
...
% OSX
\newglossaryentry{glossary-osx}{
    name = {OSX},
    description={OSX is one of the many commonly-used terms that references the operating system Apple provides with Apple computers. Alternative terms include OS X, and macOS}
}
...
\newglossaryentry{glossary-pocket-code}{
    name = {Pocket Code},
    description = {Pocket Code provides a visual programming environment where users can freely create, edit, execute, share, and remix programs with others. \href{https://play.google.com/store/apps/details?id=org.catrobat.catroid}{play.google.com/store/apps/details?id=org.catrobat.catroid}. It is one of the flagship mobile apps developed through the \acrshort{glossary-catrobat} project}
}

\newglossaryentry{glossary-pocket-paint}{
    name = {Pocket Paint},
    description = {Pocket Paint is a visual paint editor. It is also integrated into Pocket Code and can also be used on its own. \href{https://play.google.com/store/apps/details?id=org.catrobat.paintroid}{play.google.com/store/apps/details?id=org.catrobat.paintroid}. It is a popular mobile app developed through the \acrshort{glossary-catrobat} project}
}
...
\newglossaryentry{glossary-reliability}{
    name = {Reliability},
    text = {reliability},
    description = {A measure of software quality which compares the outcomes of software behaviour which can be reliable, or unreliable. The two main measures are \acrshort{mtbf} and \acrshort{pfod}. One or other of these are used at any one time, not both. See \secref{rw-stability-and-reliability} for a comparison with \gls{glossary-stability} }
}
...
% Shard, Sharded
\newglossaryentry{glossary-sharded}{
    name = {Sharded},
    text = {sharded},
    description = {Something that is split into separate shards, for instance to improve capacity and/or scaling of work. Sharding is a term particularly used in database terminology in terms of how to segment data processing.}
}
...
\newglossaryentry{glossary-stability}{
    name = {Stability},
    text = {stability},
    description = {A software quality identified initially by HP as part of their FunDex score~\cite{calleosoftware_AppPulseMobile}. The same term was subsequently used by Google to identify and measure two related indications of software failures: crashes and freezes~\cite{android_vitals_overview_2019}. These type of failure are both measures of reliability in terms of \gls{pfod}. See \secref{rw-stability-and-reliability} for a comparison with \gls{glossary-reliability}}
}
...
\newglossaryentry{glossary-technology-facing}{
    name = {Technology-facing},
    description = {The term stems from Brian Marick and his blog posts on Agile software development including software testing. An early example from his old blog is: \emph{``A technology-facing test is one you describe with words drawn from the domain of the programmers''}  \href{http://www.exampler.com/old-blog/2003/08/21.1.html}{www.exampler.com/old-blog/2003/08/21.1.html}. The concepts are well explained in Chapter 6 of \cite{crispin2009_agile_testing} on pp. 97-98 and beyond of that book}
}
...
% WebView
\newglossaryentry{glossary-webview}{
    name = {WebView},
    description = {Android WebView is a pre-installed system component from Google that allows Android apps to display web content. (Source \href{https://play.google.com/store/apps/details?id=com.google.android.webview}{play.google.com/store/apps/details?id=com.google.android.webview}.)
    }
}