...
% npm
\newacronym[type=\glsdefaulttype, description={npm is used to manage and publish software packages. \href{https://docs.npmjs.com/about-npm}{docs.npmjs.com/about-npm}, and \\ \href{https://www.w3schools.com/whatis/whatis_npm.asp}{www.w3schools.com/whatis/whatis\_npm.asp}}]{npm}{npm}{Node Package Manager}
